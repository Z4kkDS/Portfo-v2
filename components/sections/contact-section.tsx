    ...
    <section id="contact" className="py-16 relative">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <AnimatedSection animation={fadeInUp} className="text-center mb-12">
          ...
          <div className="w-20 h-1 bg-gradient-to-r from-amber-600 to-amber-500 mx-auto rounded-full mb-6"></div>
          <p className="text-xl text-stone-200/90 max-w-2xl mx-auto leading-relaxed drop-shadow-sm">
